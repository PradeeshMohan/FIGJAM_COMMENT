package com.framework.lib.reporter;
...
public class EmailReporter implements IReporter {
    ...
    private static final Logger LOG = Logger.getLogger(EmailReporter.class);
    protected final List<SuiteResult> suiteResults = Lists.newArrayList();
    // Reusable buffer
    private final StringBuilder buffer = new StringBuilder();
    protected PrintWriter writer;
    private final String dReportTitle = "Automation Test Summary";
    private final String dReportFileName = "email-report.html";
    ...
    protected void writeReportTitle(String title) {
        writer.println("<center><h1 style=\"font-size:30px\">" + title + " - " + getCurrentDateTime() + "</h1></center>");
    }
    ...
    protected void writeSuiteSummary() {
        ...
        writer.println("<center><div class=\"easy-test-overview\" style=\"tr:first-child {background-color:#D3D3D3}\">");
        writer.println("<table border='1' style=\"margin-bottom:10px;border-collapse:collapse;empty-cells:show;margin-left: auto; margin-right: auto;\" class=\"table-bordered easy-overview\">");
        writer.print("<tr>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\">Test</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># No</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># Passed</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># Skipped</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># Failed</th>");
        // writer.print("<th style=\"background-color: #5499C7;padding: 8px;vertical-align:bottom;vertical-align:bottom\">Included Groups</th>");
        // writer.print("<th style=\"background-color: #5499C7;padding: 8px;vertical-align:bottom;vertical-align:bottom\">Excluded Groups</th>");
        // writer.print("<th style=\"background-color: #5499C7;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># Browser</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># Start Time</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># End Time</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\"># Total<br/>Time(hh:mm:ss)</th>");
        writer.println("</tr>");

        int testIndex = 0;
        for (SuiteResult suiteResult : suiteResults) {
            writer.print("<tr><th style=\"padding: 10px;vertical-align:bottom;vertical-align:bottom\" colspan=\"8\">");
            ...
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                writer.print("<tr");
                if ((testIndex % 2) == 1) {
                    writer.print(" style=\"td{background-color: #E6EBF9}\" class=\"stripe\"");
                }
                writer.print(">");

                buffer.setLength(0);
                writeTableData(buffer.append("<p style=\"font-weight:bold;color:#0D1EB6\" href=\"#t").append(testIndex)
                        .append("\" > ")
        ...
        if (testIndex > 1) {
            ...
            writer.print("<tr>");
            writer.print("<th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\">Total</th>");
            ...
            writer.print("<th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" colspan=\"5\"></th>");
    ...
    protected void writeScenarioSummary() {
        writer.print("<br>");
        writer.print("<center><div class=\"easy-test-summary\">");
        writer.print("<table border='1' style=\"border-collapse:collapse;empty-cells:show\" class=\"table-bordered;\" id='summary'>");
        writer.print("<thead>");
        writer.print("<tr>");
        // writer.print("<th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Class</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Scenario</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Status</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Short Exception</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Screenshot</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Start Time</th>");
        writer.print("<th style=\"background-color: #85C1E9;padding: 8px;vertical-align:bottom;vertical-align:bottom\" >End Time</th>");
        writer.print("</tr>");
        writer.print("</thead>");
        ...
        int scenarioIndex = 0;
        for (SuiteResult suiteResult : suiteResults) {
            writer.print("<tbody><tr><th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" colspan=\"6\">");
            writer.print(Utils.escapeHtml(suiteResult.getSuiteName()));
            ...
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                if (scenarioIndex == startIndex) {
                    writer.print("<tr><th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" colspan=\"4\" class=\"invisible\"/></tr>");
                }
    ...
    private int writeScenarioSummary(String description,
        ...
        if (!classResults.isEmpty()) {
            writer.print("<tr><th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" colspan=\"6\">");
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    for (int i = 0; i < resultsCount; i++) {
                        Object[] params = results.get(i).getParameters();

                        long start = results.get(i).getStartMillis();
                        long end = results.get(i).getEndMillis();
                        ...
                        buffer.append("<td style=\"padding: 8px;vertical-align:top\"><p style=\"font-weight:bold;color:#0D1EB6\" href=\"#m").append(scenarioIndex)
                                // .append("\">").append(methodName)
                                .append("\">").append(params[0].toString().replaceAll("\"", ""))
                                .append("</p></td>").append("<td  style=\"padding: 8px;vertical-align:top\"rowspan=\"")
                                .append("\">").append(getStatusString(status))
                                .append("</p></td>").append("<td  style=\"padding: 8px;vertical-align:top\"rowspan=\"")
                                .append("\">").append(shortException)
                                .append("</td>").append("<td style=\"padding: 8px;vertical-align:top\" rowspan=\"")
                        ...
                        //buffer.append("<tr class=\"").append(cssClass)
                        //        .append("\">").append("<td style=\"padding: 8px;vertical-align:top\"><a style=\"font-weight:bold;color:#0D1EB6\" href=\"#m")
                        //        .append(scenarioIndex).append("\">")
                        //        //.append(methodName).append("</a></td></tr>");
                        //        .append(params[0]).append("</a></td></tr>");
                        scenarioIndex++;
                    }
                ...
                writer.print("\">");
                //writer.print("<td style=\"padding: 8px;vertical-align:top\" rowspan=\"");
    ...
    protected String getStatusString(int status) {
        switch (status) {
            case 1:
                return "<div style=\"font-weight: bold;display: flex;align-items:center;justify-content:center;margin: auto;vertical-align: middle;color: black;text-align: center;font-size:x-small;border-radius: 5px;background: #58D68D;width: 45px;height: 20px;\">Pass</div>";
            case 2:
                return "<div style=\"font-weight: bold;display: flex;align-items:center;justify-content:center;margin: auto;vertical-align: middle;color: black;text-align: center;font-size:x-small;border-radius: 5px;background: #E74C3C;width: 45px;height: 20px;\">Fail</div>";
            case 3:
                return "<div style=\"font-weight: bold;display: flex;align-items:center;justify-content:center;margin: auto;vertical-align: middle;color: black;text-align: center;font-size:x-small;border-radius: 5px;background: #F1C40F;width: 45px;height: 20px;\">Skip</div>";
            default:
                return "";
        }
    }
    ...
    private void writeScenario(int scenarioIndex, String label,
        ...
        if (parameterCount > 0) {
            ...
            for (int i = 1; i <= parameterCount; i++) {
                writer.print("<th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" >Parameter #");
                writer.print(i);
                writer.print("</th>");
            }
            writer.print("</tr><tr style=\"td{background-color: #E6EBF9}\" class=\"param stripe\">");
            for (Object parameter : parameters) {
                writer.print("<td style=\"padding: 8px;vertical-align:top\" >");
        ...
        if (!reporterMessages.isEmpty()) {
            writer.print("<tr><th style=\"padding: 8px;vertical-align:bottom;vertical-align:bottom\" ");
            if (parameterCount > 1) {
                writer.printf(" colspan=\"%d\"", parameterCount);
            }
            writer.print(">Messages</th></tr>");

            writer.print("<tr><td style=\"padding: 8px;vertical-align:top\"");
            if (parameterCount > 1) {
                writer.printf(" colspan=\"%d\"", parameterCount);
            }
            writer.print(">");
            writeReporterMessages(reporterMessages);
            writer.print("</td style=\"padding: 8px;vertical-align:top\"></tr>");
            hasRows = true;
        }
        ...
        writer.print("</table>");
        writer.println("<p class=\"totop\"><a style=\"font-weight:bold;color:#0D1EB6\" href=\"#summary\" style=\"margin-top:30px\">back to summary</a></p>");
    }
